        ...
        className="flex-1 text-2xl bg-white">
          <ScrollView className='h-full'>
            <View className='w-full justify-center items-center h-full px-4'>
              ...
              <RexButton title={"Log In"} handlePress={()=>{}} containerStyles={"bg-primary w-full"} textStyles={"text-white"}/>
              <RexButton title={"Sign Up"} handlePress={()=>{}} containerStyles={"bg-white w-full"} textStyles={"text-primary"}/>
            </View>
          </ScrollView>
      </SafeAreaView>
    )
