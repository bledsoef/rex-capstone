        ...
        className="flex-1 text-2xl bg-white">
          <ScrollView className='h-full'>
            <View className='w-full justify-center items-center h-full px-4'>
              <Image source={images.logo} className='w-full h-[300px]' resizeMode='contain'>
              </Image>
              ...
              <RexButton title={"Log In"} handlePress={() => router.push('/(auth)/sign-in')} containerStyles={"bg-primary w-full"} textStyles={"text-white"}/>
              <RexButton title={"Sign Up"} handlePress={() => router.push('/(auth)/sign-up')} containerStyles={"bg-white w-full"} textStyles={"text-primary"}/>
            </View>
          </ScrollView>
      </SafeAreaView>
    )
